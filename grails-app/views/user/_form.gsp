...
<div class="fieldcontain ${hasErrors(bean: userInstance, field: 'googleUsers', 'error')} ">
	<label for="googleUsers">
...
<li class="add">
<g:link controller="googleUser" action="create" params="['user.id': userInstance?.id]">${message(code: 'default.add.label', args: [message(code: 'googleUser.label', default: 'GoogleUser')])}</g:link>
</li>
</ul>
